...
PLATFORM_LOGIN_ENTRY = os.environ.get("PLATFORM_LOGIN_ENTRY", "https://chatgpt.com/auth/login")
...
JP_FIRST_NAMES = [
    "悠斗", "蓮", "陽翔", "湊", "樹", "大和", "颯真", "朝陽", "結翔", "蒼",
    "美咲", "葵", "陽菜", "結衣", "凛", "さくら", "芽依", "紬", "心春", "莉子",
]
...
def generate_random_user_info() -> dict:
    ...
    """
    profile_locale = os.environ.get("REGISTRATION_PROFILE_LOCALE", "ja-JP").lower()
    if profile_locale.startswith("ja"):
        first_name = random.choice(JP_FIRST_NAMES)
